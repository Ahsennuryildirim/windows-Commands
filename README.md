...
* Windows'taki **systeminfo** komutu, bilgisayarın donanım, yazılım, işletim sistemi ve ağ yapılandırması hakkında ayrıntılı bilgi sağlayan bir araçtır. Sistem özelliklerini hızlı bir şekilde görüntülemek veya tanılama işlemleri için kullanılır.
* Bu komut, aşağıdaki bilgileri görüntüler:
      
      İşletim sistemi adı ve sürümü
      Sistem üreticisi ve modeli
      BIOS sürümü
      Yüklü bellek miktarı
      Ağ yapılandırması
 ...
 * Windows'taki **ping** komutu, bir cihazın başka bir cihazla arasındaki bağlantıyı test etmek için kullanılan bir ağ teşhis aracıdır. Komut hedef cihaza küçük veri paketleri gönderir ve bu paketlerin geri dönüp dönmediğini kontrol eder.

           BAŞLICA İŞLEVLERİ : 

           Bağlantıyı test etmek.
           Gecikme süresini (Latency) ölçmek. 
...
* Windows'taki **dir** komutu, belirli bir klasördeki dosya ve dizinlerin listesini görüntülemek için kullanılan temel bir komuttur. Bu komut, dosya sistemindeki içerikleri hızlıca incelemek için kullanılır.

 **dir Komutunun İşlevleri :**

   * **Dosya ve Klasör Listesi Görüntüleme:** Belirli bir dizindeki dosya ve klasörleri listeler.
   * **Dosya Detaylarını Görme :** Her bir dosya veya klasörün boyutu, oluşturulma veya değiştirilme tarihi gibi bilgileri gösterir.
...
---
* Windows'taki **tracert** komutu, bir veri paketinin bir hedefe giderken geçtiği ara noktaları takip etmek için kullanılır. Bu komut, ağ yolunun her bir yönlendiricisi hakkında bilgi sağlar ve ağ bağlantısı ile ilgili olası sorunları tanımlamaya yardımcı olur.

**tracert Komutunun İşlevleri :**

  * **Ağ Yolu Takibi :** Bir veri paketinin hedefe ulaşmadan önce geçtiği her ara noktayı ve bu noktaların IP adreslerini gösterir.
...
* Windows'taki **vol** komutu, bir diskin (genellikle sabit disk veya taşınabilir bir sürücü) etiketini ve toplam kapasitesini görüntülemek için kullanılır. Bu komut, belirtilen sürücünün adı, etiketi veya dosya sistemi gibi temel bilgileri sağlar.

**vol Komutunun İşlevleri :**
...
* Windows'taki **schtasks** komutu, zamanlanmış görevler oluşturmak, yönetmek ve görüntülemek için kullanılan bir komuttur. Bu komut, belirli bir işlemi otomatik olarak belirli bir zaman diliminde çalıştırmak için kullnılır. schtasks, Windows Görev Z amanlayıcı aracını komut satırından kontrol etmek için bir araçtır.
  
**schtasks Komutunun İşlevleri:**
   *   **Zamanlanmış Görev Oluşturmak:** Belirli bir görev için zamanlama oluşturabilir ve belirli bir saatte veya düzende çalışmasını sağlayabilir. 
...
* Windows'taki **driverquery** komutu, bilgisayarınızdaki tüm yüklü sürücüleri listelemek için kullanılan bir komuttur. Bu komut, sistemdeki her bir sürücünün adı, türü ve durumu hakkında bilgi sağlar. driverquery, sistemdeki sürücülerin güncel durumunu denetlemek ve yönetmek için faydalı bir araçtır.

**driverquery Komutunun İşlevleri:**
  * **Yüklü tüm sürücüleri Listeleme :** Sisteminizde yüklü olan tüm sürücüleri ve durumlarını görüntüler.
...
* Windows'taki **sc** komutu, Service Control aracı olarak bilinir ve bilgisayarınızdaki hizmetleri yönetmek için kullanılır. Bu komut, hizmetleri başlatmak, durdurmak, durumu kontrol etmek, konfigürasyonlarını değiştirmek ve daha fazlasını yapmak için kullanılabilir.

**sc Komutunun İşlevleri**
   * **Hizmet Durumunu Görüntüleme:** Bir hizmetin çalışıp çalışmadığını kontrol edebilirsiniz. 
...
* Windows'taki **arp** komutu, Address Resolution Protocol tablosunu görüntülemek ve yönetmek için kullanılır. ARP, bir cihazın IP adresini, yerel ağdaki fiziksel adresine eşler. 
...
* Windows'taki **pathping** komutu, ağ bağlantıları üzerinde yapılan bir test aracıdır.  **ping** ve **tracert** komutlarının birleşimi gibi çalışır.
...
* Windows'taki **nbtstat** komutu, NetBIOS over TCP/IP protokolüyle ilgili bilgileri görüntülemek için kullanılır. NetBIOS, bilgisayarlar arasında ağ üzerinden iletişim kurmak için kullanılan eski bir protokoldür.
